...
public class DataManager {
    ...
    public DataManager() {
        mainMenus = new Menu[] {
                ...
                new MainMenu(3, "강정버거", "차승환의 강정버거", 2000)
        };

        sideMenus = new Menu[] {
                new SideMenu(4, "감자튀김", "바삭한 프렌치프라이", 2500),
                new SideMenu(5, "치즈스틱", "고소한 치즈 튀김", 3000)
        };

        drinkMenus = new Menu[] {
                new DrinkMenu(6, "콜라", "시원한 탄산음료", 1500),
                new DrinkMenu(7, "사이다", "청량한 탄산", 1500)
        };
    }
